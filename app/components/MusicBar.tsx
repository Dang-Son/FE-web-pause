...
const MusicBar = () => {
  ...
  return (
    <div className="fixed w-full h-auto bottom-0 bg-gray-100 z-50 border-t border-gray-300">
      <div className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 h-12">
        {/* Backward */}
        <button className="">
          <svg
        ...
        <div className="flex items-center">
          ...
          <div className="">
            <div className="flex items-center h-1 min-w-[400px] bg-green-500 ">
              <div className=" rounded-full w-2 h-2 bg-orange-200 shadow hover:cursor-pointer"></div>
            </div>
          </div>
        ...
        {/* Song */}
        <div className="song flex items-center space-x-5">
          <img
            className="object-center w-9 h-9 "
